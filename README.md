...
The objective of this project is to use the Pandas library to read dataset, filter/sort, index data, aggregate, and join/merge/concatenate data from a dataset.
</td></tr>
</table>
