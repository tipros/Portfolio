...
The objective of this project is to leverage Excel to create PIVOT tables from a dataset, use XLOOKUP, use common formulas for data clean-up and statistics, conditional formatting, generate charts, and data clean-up exercise.
</td></tr>
